...
// DecodeEncryptRequest fills struct from json request
...
// DecodeDecryptRequest fills the decrypt struct from json request
...
// EncodeResponse is common for both encrypt and decrypt responses
